...
class FormGenerator
{
    ...
    public function generate($settings)
    {
        ...
        self::$formFile = str_replace('pub', '', $_SERVER['DOCUMENT_ROOT']) . 'app/code/' . str_replace('_', '/', $settings['listingModule']) . '/view/adminhtml/ui_component/' . $this->getFileName($settings) . '_form.xml';
        self::$layoutContentToCreate = [
            "form" => [
                "_value" => [
                            ...
                            [
                                "item" => [
                                    "_value" => [
                                        [
                                            "item" => [
                                                "_value" => $this->getFileName($settings) . '_form.' . $this->getFileName($settings) . '_form_data_source',
                                                "_attribute" => [
                                                    "name" => "provider",
                                                    "xsi:type" => "string"
                                                ]
                            ...
                            [
                                "item" => [
                                    "_value" => [
                                        ...
                                        [
                                            "item" => [
                                                "_value" => $this->getFileName($settings) . '_form',
                                                "_attribute" => [
                                                    "name" => "namespace",
                                                    "xsi:type" => "string"
                                                ]
                            ...
                            [
                                "item" => [
                                    "_value" => [
                                        ...
                                        [
                                            "item" => [
                                                "_value" => str_replace('_', '\\', $this->getVendorModelName($settings)) . '\\Block\\Adminhtml\\Buttons\\Delete',
                                                "_attribute" => [
                                                    "name" => "delete",
                                                    "xsi:type" => "string"
                                                ]
                        ...
                        "_value" => [
                            ...
                            "dataProvider" => [
                                ...
                                "_attribute" => [
                                    ...
                                    "name" => $this->getFileName($settings) . "_form_data_source"
                                ]
                            ]
                        ],
                        "_attribute" => [
                    ...
                    "fieldset" => [
                        "_value" => $this->getFildsetData($settings),
                        "_attribute" => [
                            "name" => $this->getFileName($settings) . '_form_details'
                        ]
                    ]
                ],
                "_attribute" => [
    ...
    public function getFildsetData($settings)
    {
        $data = [];
        $data[] = [
            "argument" => [
