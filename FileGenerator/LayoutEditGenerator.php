...
class LayoutEditGenerator
{
    ...
    public function generate($settings)
    {
        ...
        self::$layoutFile = str_replace('pub', '', $_SERVER['DOCUMENT_ROOT']) . 'app/code/' . str_replace('_', '/', $settings['listingModule']) . '/view/adminhtml/layout/' . strtolower($this->getVendorModelName($settings)) . '_'.$this->getSmallModelName($settings).'_edit.xml';
                            ...
                            "referenceContainer" => [
                                "_value" => [
                                    "uiComponent" => [
                                        "_value" => [],
                                        "_attribute" => [
                                            "name" => strtolower($this->getVendorModelName($settings)) . "_" . strtolower($this->getModelName($settings)) . "_form"
                                        ]
                                    ]
                                ],
                                "_attribute" => [
